...
execute_process(
  COMMAND "/usr/bin/git" show-ref "7792b1e909a98703181aecb8810b4b654004c25d"
  WORKING_DIRECTORY "/home/ubuntu/libternsorflowlite_c/tflite_build/eigen"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/ubuntu/libternsorflowlite_c/tflite_build/eigen'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/ubuntu/libternsorflowlite_c/tflite_build/eigen'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
