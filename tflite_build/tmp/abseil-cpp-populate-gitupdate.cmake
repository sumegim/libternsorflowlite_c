...
execute_process(
  COMMAND "/usr/bin/git" show-ref "997aaf3a28308eba1b9156aa35ab7bca9688e9f6"
  WORKING_DIRECTORY "/home/ubuntu/libternsorflowlite_c/tflite_build/abseil-cpp"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/ubuntu/libternsorflowlite_c/tflite_build/abseil-cpp'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/ubuntu/libternsorflowlite_c/tflite_build/abseil-cpp'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
